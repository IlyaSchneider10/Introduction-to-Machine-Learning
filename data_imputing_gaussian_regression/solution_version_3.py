...
from sklearn.gaussian_process.kernels import DotProduct, RBF, Matern, RationalQuadratic, CompoundKernel, Exponentiation, Hyperparameter, PairwiseKernel
...
def modeling_and_prediction(X_train, y_train, X_test):
    ...
    best_kenel = kernels[np.argmin(kernel_summary)]

    gpr = GaussianProcessRegressor(kernel=best_kenel)
...
if __name__ == "__main__":
    ...
    dt.to_csv('results_3.csv', index=False)
